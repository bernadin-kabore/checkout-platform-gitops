...
lives in
[checkout-platform-source](https://github.com/bernadin-kabore/checkout-platform-source) —
and it holds no scripts that deploy anything. It is a description of the
desired state of checkout-platform in each environment, and ArgoCD's job is
